...
// Type: Novensys.ASN1.Type.Asn1PrintableStringType
...
{
  [Serializable]
  public class Asn1PrintableStringType : Asn1KnownMultiplierStringType
  {
    ...
    public Asn1PrintableStringType()
    {
    }

    public Asn1PrintableStringType(string str)
      : base(str)
    {
    }
    ...
    protected internal override void __setTypeValue(Asn1Type typeInstance)
    {
      ...
      {
        if (!(typeInstance is Asn1PrintableStringType))
          return;
    ...
    {
      return this == anObject || anObject is Asn1PrintableStringType && this.HasEqualValue((Asn1StringType) anObject);
    }
