...
// Type: Novensys.ASN1.Type.Asn1ISO646StringType
...
{
  [Serializable]
  public class Asn1ISO646StringType : Asn1KnownMultiplierStringType
  {
    ...
    public Asn1ISO646StringType()
    {
    }

    public Asn1ISO646StringType(string str)
      : base(str)
    {
    }
    ...
    protected internal override void __setTypeValue(Asn1Type typeInstance)
    {
      if (typeInstance == null)
        this.ResetType();
      else if (typeInstance is Asn1ISO646StringType)
      {
    ...
    {
      return this == anObject || (anObject is Asn1ISO646StringType || anObject is Asn1VisibleStringType) && this.HasEqualValue((Asn1StringType) anObject);
    }
