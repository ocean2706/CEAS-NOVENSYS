...
// Type: Novensys.ASN1.UnalignedBasicPerEncoder
...
{
  [Serializable]
  public class UnalignedBasicPerEncoder : Asn1TypePerWriter
  {
    ...
    public static bool IsEncodingRulesEnabled
    {
      get
      {
        return UnalignedBasicPerEncoder._encodingRulesEnabled;
      }
    }
    ...
    public UnalignedBasicPerEncoder()
      : base(false)
    {
      if (!UnalignedBasicPerEncoder._encodingRulesEnabled)
    ...
    {
      UnalignedBasicPerEncoder._encodingRulesEnabled = b;
    }
