...
// Type: Novensys.ASN1.UnalignedPerDecoder
...
{
  [Serializable]
  public class UnalignedPerDecoder : Asn1TypePerReader
  {
    ...
    public static bool IsEncodingRulesEnabled
    {
      get
      {
        return UnalignedPerDecoder._encodingRulesEnabled;
      }
    }

    public UnalignedPerDecoder()
      : base(false)
    {
      if (!UnalignedPerDecoder._encodingRulesEnabled)
    ...
    {
      UnalignedPerDecoder._encodingRulesEnabled = b;
    }
    ...
    public override IList PropertyNames()
    {
      ...
      list.Add((object) "ignoringPostPaddingBits");
