...
// Type: Novensys.eCard.SDK.ASN1.EHCDG6.Diagnostic
...
{
  [Serializable]
  public class Diagnostic : Asn1SequenceType
  {
    public string Code
    {
      get
    ...
    public void SetValue(Diagnostic typeInstance)
    {
      this.__setTypeValue((Asn1Type) typeInstance);
    }

    public Diagnostic._code code()
    {
      this.__setComponentIsDefined(0);
      return (Diagnostic._code) this.__instantiateTypeByIndex(0);
    }
    ...
    protected internal override Asn1Type __instantiateTypeByIndex(int index)
    {
      ...
      if (index == 0)
      {
        ...
        {
          typeInstance = (Asn1Type) new Diagnostic._code();
